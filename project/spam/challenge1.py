...
inputstr = '''2911threeninesdvxvheightwobm
...
texttodigit = [["one", "o1e"], ["two", "t2o"], ["three", "t3e"], ["four", "f4r"], ["five", "f5e"], ["six", "s6x"], ["seven", "s7n"], ["eight", "e8t"], ["nine", "n9e"], ["zero", "z0o"]]
...
for line in inputlist:
    ...
    first = ""
    last = ""
    for digit in texttodigit:
        linev2 = linev2.replace(digit[0], digit[1])
    l = len(linev2) 
